...
ALACRITTY_C		:= $(CONF)/alacritty/alacritty.toml
GTK2			:= ~/.gtkrc-2.0
GTK3			:= $(CONF)/gtk-3.0
...
TARGETS	= $(BASHRC) $(XSESSION) $(XINITRC) $(GTK2) $(GTK3) $(ALACRITTY_C) $(REDSHIFT) $(CLANG_FMT) $(GITCONFIG) $(AWESOME) $(AVIM_USER) $(AVIM_POLISH) $(VIBE)
