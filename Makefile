...
install:
	sudo apt install firmware-linux xorg xcompmgr gcc network-manager feh neovim git redshift fonts-firacode fonts-font-awesome glibc-doc exuberant-ctags clang-format curl awesome awesome-extra
	make clean
	make $(TARGETS)
	make $(NVIM_P)
	make $(ALACRITTY)
